...
public class menuEstanteria extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (this.jTable1.getSelectedRowCount() == 0 || this.jTable1.getSelectedRowCount() > 1) {
            ...
            char cod = jTable1.getModel().getValueAt(filaSelecc, 1).toString().charAt(0);
            String comp = jTable1.getModel().getValueAt(filaSelecc, 2).toString();
            String ubi = jTable1.getModel().getValueAt(filaSelecc, 3).toString();
            Entidades.Estanteria seleccionada = new Entidades.Estanteria(id,cod,ubi,Boolean.parseBoolean(comp));
            
            modificarEstanteria mest = new modificarEstanteria(this, seleccionada);
